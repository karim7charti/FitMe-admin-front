...
class AddEmploye extends Component{
    ...
    state={
        ...
        monthly_Amount:this.props.item.monthly_Amount,
        id_profe:this.props.item.id_profe,
        paymentDay:this.props.item.paymentDay,
    ...
    updateEmploye=e=>{
        ...
        axios.post('/editEmploye/'+this.props.item.id,payload).then(res=>{
            ...
            else
            {
                this.props.updateListElemnt(res.data)
                   swal({
                    title: "good job!",
                    text: "employe updated succefuly",
                    icon: "success",
                });
    ...
    render() {
        ...
        return (this.props.trigger) ? (
            ...
            <form method="post" onSubmit={this.updateEmploye}>
